...
public static class SystemParametersInfoHelper
{
    public static void DisableSingleTap()
    {
        ...
        unsafe
        {
            ...
            Console.WriteLine(param.TapEnabled);

            param.TapEnabled = !param.TapEnabled;

            result = PInvoke.SystemParametersInfo((SYSTEM_PARAMETERS_INFO_ACTION)SPI_SETTOUCHPADPARAMETERS,
                size, &param, SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS.SPIF_SENDCHANGE | SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS.SPIF_UPDATEINIFILE | SYSTEM_PARAMETERS_INFO_UPDATE_FLAGS.SPIF_SENDWININICHANGE);
